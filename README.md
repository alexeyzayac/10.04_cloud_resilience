# Домашнее задание к занятию 3 "`Отказоустойчивость в облаке`" - `Заяц Алексей`
...
2. [Документация сетевого балансировщика нагрузки](https://yandex.cloud/ru/docs/network-load-balancer/quickstart)
...
[Terraform Playbook](terraform-playbook)
